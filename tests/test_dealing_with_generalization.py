...
class TestPullUpMethod(RefactoringTestBase):
    ...
    def test_simple(self):
        ...
        self.refactor(
            "pull-up-method",
            target="Salesman::get_annual_cost",
            to="Employee"
        )
