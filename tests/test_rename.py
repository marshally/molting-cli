...
class TestRenameFunction(RefactoringTestBase):
    ...
    def test_simple(self):
        ...
        self.refactor("rename", target="add_numbers", new_name="calculate_sum")
...
class TestRenameMethod(RefactoringTestBase):
    ...
    def test_class_method(self):
        ...
        self.refactor("rename", target="Calculator::add_numbers", new_name="calculate_sum")
...
class TestRenameClass(RefactoringTestBase):
    ...
    def test_rename_class_simple(self):
        """Rename a class."""
        self.refactor("rename", target="Calculator", new_name="MathEngine")
...
class TestRenameVariable(RefactoringTestBase):
    ...
    def test_rename_local_variable(self):
        ...
        self.refactor("rename", target="count", new_name="total")
...
class TestRenameCLI:
    ...
    def test_rename_command_basic(self, tmp_path):
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["rename", str(test_file), "old_name", "new_name"])
