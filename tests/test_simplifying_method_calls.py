...
class TestRenameMethod(RefactoringTestBase):
    ...
    def test_simple(self):
        ...
        self.refactor(
            "rename-method",
            target="Customer::get_inv_cdtlmt",
            new_name="get_invoice_credit_limit"
        )
...
class TestRemoveParameter(RefactoringTestBase):
    ...
    def test_simple(self):
        ...
        self.refactor(
            "remove-parameter",
            target="Order::calculate_total::discount_code"
        )
...
class TestReplaceParameterWithExplicitMethods(RefactoringTestBase):
    ...
    def test_simple(self):
        ...
        self.refactor(
            ...
            target="Employee::set_value::name"
        )
...
class TestReplaceParameterWithMethodCall(RefactoringTestBase):
    ...
    def test_simple(self):
        ...
        self.refactor(
            ...
            target="Order::discounted_price::discount_level"
        )
...
class TestHideMethod(RefactoringTestBase):
    ...
    def test_simple(self):
        ...
        self.refactor(
            "hide-method",
            target="Employee::get_bonus_multiplier"
        )
